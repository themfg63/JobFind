...
const PostedJobDesc = () => {
    return <div className="mt-5 w-3/4 px-5">
        <div className="text-2xl font-semibold flex items-center">
            Software Engineer
            <Badge variant="light" ml="sm" color="brightSun.4" size="sm">Rozet</Badge>
        </div>
        <div className="font-medium text-mine-shaft-300 mb-5">Ankara, Türkiye</div>
        <div>
            <Tabs variant="outline" radius="lg" defaultValue="overview">
                <Tabs.List className="[&_button]:!text-lg font-semibold mb-5 [&_button[data-active='true']]:text-bright-sun-400">
                    <Tabs.Tab value="overview">Detaylar</Tabs.Tab>
                    <Tabs.Tab value="applicants">Başvurular</Tabs.Tab>
                    <Tabs.Tab value="invited">Davet Edilenler</Tabs.Tab>
                </Tabs.List>
